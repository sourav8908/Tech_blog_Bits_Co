    ...
    <div className="min-h-screen relative bg-white dark:bg-gray-900">
      ...
      <div className="max-w-2xl pt-20 pb-32 px-6 text-center mx-auto">
        ...
        <p className="text-gray-600 mt-4 dark:text-indigo-200">
          I am a self taught developer Currently pursuing my M.Tech at IIT Patna, where I’m honing advanced skills in backend development, data structures, and scalable system design.
          .I am particularly passionate about designing systems that are scalable, maintainable, and performance-oriented. I take pride in writing clean, efficient, and testable code.
          Whenever possible, I channel my enthusiasm into building scalable solutions using Java-based distributed systems and modern frameworks and libraries  such as Spring Boot and React.js
        </p>
        ...
        <div className="text-center pt-8">
          <button className="bg-indigo-500 px-3 py-1 font-semibold text-white inline-flex items-center space-x-2 rounded dark:bg-indigo-600">
            ...
            <a
              ...
              target="_blank"
              href="https://sourav8908-portfolio.vercel.app/"
            >
              See My Works
            </a>
          </button>
